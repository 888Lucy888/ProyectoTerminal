...
// /:https://framerusercontent.com/modules/Z5xmLQFgrHwhySDOsKSW/lck97Hty3hyBX0caHHRx/A1Al_1Wam.js
...
var serializationHash = "framer-vpzD8";
...
var Component = /* @__PURE__ */ React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ _jsx(LayoutGroup, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx(Variants, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx(Transition, { value: transition1, children: /* @__PURE__ */ _jsx(motion.div, { ...restProps, ...gestureHandlers, className: cx(scopingClassNames, "framer-ydctlg", className, classNames), "data-framer-name": "Variant 1", layoutDependency, layoutId: "kpyb84WUT", ref: refBinding, style: { backgroundColor: HRpYUqfiX, borderBottomLeftRadius: 20, borderBottomRightRadius: 20, borderTopLeftRadius: 20, borderTopRightRadius: 20, ...style }, children: /* @__PURE__ */ _jsx(motion.div, { className: "framer-11wlfeh", layoutDependency, layoutId: "Q2TRbkC03", style: { backgroundColor: "var(--token-c168b98c-2e59-445e-b5bc-c16129fabd04, rgb(33, 181, 40))", borderBottomLeftRadius: 10, borderBottomRightRadius: 10, borderTopLeftRadius: 10, borderTopRightRadius: 10 } }) }) }) }) });
});
var css = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-vpzD8.framer-j2o769, .framer-vpzD8 .framer-j2o769 { display: block; }", ".framer-vpzD8.framer-ydctlg { align-content: center; align-items: center; display: flex; flex-direction: row; flex-wrap: nowrap; gap: 10px; height: 20px; justify-content: center; overflow: visible; padding: 0px; position: relative; width: 20px; }", ".framer-vpzD8 .framer-11wlfeh { aspect-ratio: 1 / 1; flex: none; height: var(--framer-aspect-ratio-supported, 12px); overflow: visible; position: relative; width: 12px; }", "@supports (background: -webkit-named-image(i)) and (not (font-palette:dark)) { .framer-vpzD8.framer-ydctlg { gap: 0px; } .framer-vpzD8.framer-ydctlg > * { margin: 0px; margin-left: calc(10px / 2); margin-right: calc(10px / 2); } .framer-vpzD8.framer-ydctlg > :first-child { margin-left: 0px; } .framer-vpzD8.framer-ydctlg > :last-child { margin-right: 0px; } }"];
var FramerA1Al_1Wam = withCSS(Component, css, "framer-vpzD8");
